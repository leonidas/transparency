(function() {
  ...
  Transparency.render = function(contexts, objects, directives) {
    var c, i, n, object, parent, result, sibling, _base, _base2, _base3, _i, _j, _k, _len, _len2, _len3, _len4, _ref, _ref2;
  ...
  matchingElements = function(template, key) {
    var fc, matchPredicate, _base, _base2;
    if (!(fc = template.firstChild)) return [];
    fc.t || (fc.t = {});
    (_base = fc.t).qc || (_base.qc = {});
    return (_base2 = fc.t.qc)[key] || (_base2[key] = template.querySelectorAll ? template.querySelectorAll("#" + key + ", " + key + ", ." + key + ", [data-bind='" + key + "']") : (matchPredicate = function(e) {
