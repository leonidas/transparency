(function() {
  var ELEMENT_NODE, Transparency, matchingElements, prepareContext, renderChildren, renderDirectives, renderValues, setText;
  ...
  matchingElements = function(template, key) {
    ...
    return (_base2 = firstChild.transparency.queryCache)[key] || (_base2[key] = jQuery(template).find("#" + key + ", " + key + ", ." + key + ", [data-bind='" + key + "']"));
  };
