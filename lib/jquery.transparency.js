(function() {
  ...
  window.t.render = render = function(contexts, objects, directives) {
    var c, context, i, n, object, parent, sibling, t, template, _base, _base2, _i, _j, _k, _len, _len2, _len3, _len4, _ref, _ref2;
    ...
    for (_i = 0, _len = contexts.length; _i < _len; _i++) {
      ...
      context.t || (context.t = {});
      (_base = context.t).instances || (_base.instances = []);
      (_base2 = context.t).template || (_base2.template = (function() {
        var _results;
        _results = [];
