(function() {
  var ELEMENT_NODE, Transparency, elementMatcher, matchingElements, prepareContext, renderChildren, renderDirectives, renderValues, setHtml, setText;
      ...
      _results.push((function() {
        ...
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          ...
          if (attr) {
            ...
            if ((v != null ? v.safe : void 0) === true) {
              _results2.push(setHtml(e, v.value));
            } else {
              _results2.push(setText(e, v));
            }
          }
  ...
  setHtml = function(e, html) {
    ...
    if ((e != null ? (_ref = e.transparency) != null ? _ref.html : void 0 : void 0) === html) {
      return;
    }
    e.transparency || (e.transparency = {});
