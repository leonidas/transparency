...
(function() {
  ...
  (function(root, factory) {
    ...
    var ELEMENT_NODE, TEXT_NODE, attr, cloneNode, data, debug, debugMode, elementMatcher, elementNodes, expando, getText, html5Clone, isDate, isPlainValue, matchingElements, prepareContext, render, renderChildren, renderDirectives, renderValues, setContent, setHtml, setText, _base;
    if ($ != null) {
      $.fn.render = function(models, directives, config) {
        var context, _i, _len;
