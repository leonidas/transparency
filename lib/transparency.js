...
(function() {
  ...
  (function(root, factory) {
    ...
    render = function(context, models, directives, config) {
      var childKeys, contextData, e, element, index, instance, key, model, parent, sibling, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1;
      log = logger(config);
      ...
      for (index = _i = 0, _len = models.length; _i < _len; index = ++_i) {
        ...
        for (_k = 0, _len2 = childKeys.length; _k < _len2; _k++) {
          key = childKeys[_k];
          _ref1 = matchingElements(instance, key, config);
    ...
    renderValues = function(instance, model, childKeys) {
      var element, key, value, _results;
      if (isDomElement(model) && (element = instance.elements[0])) {
        return empty(element).appendChild(model);
        ...
        for (key in model) {
          ...
          if (isPlainValue(value)) {
            ...
            _results.push(childKeys.push(key));
          } else {
