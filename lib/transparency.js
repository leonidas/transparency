...
(function() {
  var ELEMENT_NODE, T, Transparency, cloneNode, debug, debugMode, elementMatcher, elementNodes, expando, isDate, matchingElements, pad, prepareContext, renderChildren, renderDirectives, renderValues, setContent, setHtml, setText, _base, _base1, _base2,
    __slice = [].slice;
  ...
  if ((_base1 = Array.prototype).isArray == null) {
    _base1.isArray = function(obj) {
  ...
  if ((_base2 = Date.prototype).toISOString == null) {
    _base2.toISOString = function() {
