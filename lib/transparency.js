(function() {
  var ELEMENT_NODE, T, Transparency, cloneNode, debug, elementMatcher, elementNodes, expando, matchingElements, prepareContext, renderChildren, renderDirectives, renderValues, setContent, setHtml, setText, _base,
  ...
  T.render = function(context, models, directives) {
  ...
  debug = function() {
    ...
    if (T.debug) {
      ...
      for (_i = 0, _len = messages.length; _i < _len; _i++) {
        m = messages[_i];
        _results.push(typeof console !== "undefined" && console !== null ? console.log(m) : void 0);
      }
      return _results;
    }
  };
