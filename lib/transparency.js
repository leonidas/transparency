...
(function() {
  var ELEMENT_NODE, T, Transparency, cloneNode, debug, debugMode, elementMatcher, elementNodes, expando, isDate, matchingElements, pad, prepareContext, renderChildren, renderDirectives, renderValues, setAttribute, setContent, setHtml, setText, _base, _base1,
    __slice = [].slice;
  ...
  setText = setContent(function(e, text) {
    if (e.nodeName.toLowerCase() === 'input') {
      return setAttribute(e, 'value', text);
    } else {
