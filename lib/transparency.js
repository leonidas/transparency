...
(function() {
  var ELEMENT_NODE, T, Transparency, cloneNode, debug, debugMode, elementMatcher, elementNodes, expando, getText, html5Clone, isDate, matchingElements, pad, prepareContext, renderChildren, renderDirectives, renderValues, setAttribute, setContent, setHtml, setText, _base, _base1,
    __slice = [].slice;
