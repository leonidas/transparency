(function() {
  var ELEMENT_NODE, T, Transparency, cache, elementMatcher, elementNodes, expando, matchingElements, prepareContext, renderChildren, renderDirectives, renderValues, setContent, setHtml, setText, uid, _base;
