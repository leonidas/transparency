(function() {
  var ELEMENT_NODE, T, Transparency, clone, elementMatcher, elementNodes, expando, matchingElements, prepareContext, renderChildren, renderDirectives, renderValues, setContent, setHtml, setText, _base;
    ...
    while (models.length > contextData.instances.length) {
      ...
      instance.template || (instance.template = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          n = _ref[_i];
          if (n.nodeType === ELEMENT_NODE) _results.push(clone(n));
        }
        return _results;
      })());
