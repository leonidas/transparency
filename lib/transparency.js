...
(function() {
  var ELEMENT_NODE, T, Transparency, cloneNode, debug, debugMode, elementMatcher, elementNodes, expando, isDate, matchingElements, pad, prepareContext, renderChildren, renderDirectives, renderValues, setContent, setHtml, setText, _base, _base1,
    __slice = [].slice;
  ...
  cloneNode = document.createElement("nav").cloneNode(true).outerHTML !== "<:nav></:nav>" ? function(node) {
    ...
    if (node.nodeType === ELEMENT_NODE && node.nodeName.toLowerCase() !== "option") {
      ...
      if ((_ref = div.firstChild) != null) {
        _ref.removeAttribute(expando);
      }
