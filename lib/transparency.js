...
(function() {
  var ELEMENT_NODE, T, Transparency, cloneNode, debug, debugMode, elementMatcher, elementNodes, expando, getText, html5Clone, isDate, isPlainValue, matchingElements, prepareContext, renderChildren, renderDirectives, renderValues, setAttribute, setContent, setHtml, setText, _base,
    __slice = [].slice;
        ...
        _results.push((function() {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            if (element.nodeName.toLowerCase() === 'input') {
              _results1.push(setAttribute(element, 'value', value));
            } else {
              _results1.push(setAttribute(element, 'text', value));
            }
          }
          return _results1;
        })());
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          _results1.push((function() {
            ...
            for (attribute in attributes) {
              ...
              value = directive.call((typeof model === 'object' ? model : {
                value: model
              }), element, index);
              if (value) {
                _results2.push(setAttribute(element, attribute, value));
              } else {
